...
<a href="https://github.com/terraform-az-modules/terraform-azurerm-static-web-app/actions/workflows/checkov.yml">
  <img src="https://github.com/terraform-az-modules/terraform-azurerm-static-web-app/actions/workflows/checkov.yml/badge.svg" alt="checkov">
</a>
...
This module includes Terraform code, examples, and automation tests to help you provision Azure Static Web Apps with minimal duplication and clear conventions.
...
> ⚠️ **Important:** Avoid using the `master` branch directly, as it may include unstable changes. Always use stable [release versions](https://github.com/terraform-az-modules/terraform-azurerm-static-web-app/releases).
...
<div align="center">
  <a href="https://github.com/terraform-az-modules/terraform-azurerm-static-web-app/graphs/contributors" title="Contributors">
    <img src="https://contrib.rocks/image?repo=terraform-az-modules/terraform-azurerm-static-web-app" />
  </a>
</div>
